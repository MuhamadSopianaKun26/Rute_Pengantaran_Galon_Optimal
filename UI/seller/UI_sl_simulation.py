...
class SellerSimulation(QWidget):
    def __init__(self, parent=None, current_user: dict | None = None, marker_deleted=None):
        ...
        # Pastikan list terinisialisasi agar tidak None saat di-append
        self.marker_deleted = marker_deleted if isinstance(marker_deleted, list) else []
    ...
    def on_reset_clicked(self):
        ...
        # Bersihkan daftar marker yang sudah dihapus
        try:
            self.marker_deleted.clear()
        except Exception:
            self.marker_deleted = []
        self.map_loaded = False 
